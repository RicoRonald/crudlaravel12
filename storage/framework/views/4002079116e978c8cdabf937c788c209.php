...
<html>
    ...
    <h2><a href="https://www.us.ac.id">www.usm.ac.id</a></h2>
    <h3>Edit Pegawai</h3>
    ...
    <form action="/pegawai/update" method="post">
        ...
        <input type="hidden" name="id" value="<?php echo e($p->pegawai_id); ?>">
        <br/>
...
</html><?php /**PATH C:\xampp1\htdocs\data-pegawai\resources\views/edit.blade.php ENDPATH**/ ?>